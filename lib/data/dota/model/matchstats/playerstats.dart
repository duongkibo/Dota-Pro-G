...
class PlayerStats extends Equatable {
  ...
  List<Object> get props {
    return [id,matchId,name,personaName,playerSlot,assists,backpack0,backpack1,backpack2,deaths,denies,goldPerMin
    ,heroDamage,heroHealing,heroId,item0,item1,item2,item3,item4,item5,itemNeutral,kills,lastHits,level,towerDamage,xpPerMin
    ,purchaseWardObserver,purchaseWardSentry];
  }
}
